...
from experiments.ppo_config import ppo_csc_config, tune_resources
...
tuner = tune.Tuner(
    ...
    run_config=RunConfig(stop=stopper,
                         ...
                         storage_path=get_persistent_folder("ray_results/csc", __file__),
                         ),
...
algo.save(f"{algo}_cc_tune_check")
