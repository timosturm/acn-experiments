...
from src.imitation.objective import objective_IL, objective_combined
from src.rewards import sparse_soc_reward
from src.utils import get_generator, get_power_function
...
args = MyArgs(
    ...
    imitation=ImitationArgs(
        ...
        train_ds="caltech_46_weeks_training.parquet.gzip",
        validation_ds="caltech_46_weeks_validation.parquet.gzip",
        hiddens=hiddens,
    ),
    eval=EvalArgs(
