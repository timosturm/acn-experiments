...
def objective_IL(
    ...
    for epoch, state_dict, validation_loss in imitate(args.imitation, writer, device, state_dict=None):
        ...
        if validation_loss < old_validation_loss:
            print(
                f"New best model at epoch={epoch} with validation_loss={validation_loss}!")
