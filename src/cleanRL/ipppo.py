...
def train_ppo(
    ...
    # TODO Make a dict of agents {station_id: agent}
    agent = Agent(
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            obs[step] = next_obs  # TODO
            dones[step] = next_done  # TODO
            ...
            actions[step] = action  # TODO
            logprobs[step] = logprob  # TODO

            # TRY NOT TO MODIFY: execute the game and log data.
            new_action = action.cpu().numpy()  # TODO
            next_obs, reward, terminations, truncations, infos = envs.step(
                new_action)

            next_done = np.logical_or(terminations, truncations)  # TODO
            rewards[step] = torch.tensor(reward).to(device).view(-1)  # TODO
            next_obs, next_done = torch.Tensor(next_obs).to(
                device), torch.Tensor(next_done).to(device)  # TODO

            # TODO Does this wrapper work?
