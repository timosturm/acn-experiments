...
def main(transformer_cap: int, reward_cfg: str, ent_coef: float, learning_rate: float):
    ...
    file_path = f"../caltech_#stations={len(charging_network.station_ids)}_#days={train_generator._simulation_days}_#intervals={train_generator._n_intervals}_transformer_cap={transformer_cap}_seed=8734956.pkl"
